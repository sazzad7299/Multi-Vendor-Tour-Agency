            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div id="response"></div>
                        <form method="POST" action="{!! action('PageSettingsController@bannerupdate',['id' => $banner->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <img style="max-width: 250px;" src="{{url('assets/images/brands')}}/{{$banner->image}}">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="link" value="{{$banner->link}}" placeholder="Enter Blog Title" required="required" type="text">
                                </div>
                            </div>
