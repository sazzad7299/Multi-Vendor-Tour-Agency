                                            ...
                                            <form method="POST" action="service/titles" class="form-horizontal form-label-left" id="website_form">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input class="form-control col-md-7 col-xs-12" name="service_title" placeholder="Service Title" required="required" type="text" value="{{$titles->service_title}}">
                                                    </div>
                                                </div>
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <textarea rows="6" class="form-control" name="service_text">{{$titles->service_text}}</textarea>
                                                    </div>
                                                </div>
