            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        @endif
                        <div id="response"></div>
                        <form method="POST" action="{!! action('ChildCategoryController@store') !!}" class="form-horizontal form-label-left">
                            {{csrf_field()}}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="subid" id="subs" disabled required>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="e.g Mens Clothing" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
