                        ...
                        <form method="POST" action="{!! action('ProductController@update',['id' => $product->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                   <img style="max-width: 250px;" src="{{url('assets/images/products/small')}}/{{$product->feature_image}}" id="adminimg" alt="No Featured Image Added">
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text"  name="startDate" id="dt1" class="form-control" autocomplete="off"  value="{{ $product->startDate }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ $product->endDate }}"  name="endDate" id="dt2" class="form-control" autocomplete="off">
                                </div>
                            </div>
